...
export default function TypewriterRole() {
  ...
  return (
    <motion.div className="relative text-xl md:text-2xl mb-6 h-16 flex items-center justify-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}>
      ...
      <motion.div className="relative overflow-hidden rounded-2xl px-6 py-3 min-w-[280px]" initial={{ scale: 0.8 }} animate={{ scale: 1 }} transition={{ delay: 0.6, type: "spring", stiffness: 200 }}>
        ...
        <motion.div className="absolute inset-0 opacity-20 rounded-2xl" animate={{ rotate: [0, 360] }} transition={{ duration: 25, repeat: Infinity, ease: "linear" }}>
        ...
        <div className="relative z-10 text-center">
          <motion.span
            ...
            animate={{
              textShadow: ["0 0 10px rgba(255,255,255,0.3)", "0 0 20px rgba(255,255,255,0.6)", "0 0 10px rgba(255,255,255,0.3)"],
            }}
            transition={{ duration: 2, repeat: Infinity }}
          >
            {displayText}
            <motion.span className="inline-block w-0.5 h-6 bg-white/80 ml-1" animate={{ opacity: [0, 1, 0] }} transition={{ duration: 1, repeat: Infinity }} />
          </motion.span>
        </div>
