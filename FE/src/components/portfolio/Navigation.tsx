        ...
        <div className="flex justify-between items-center gap-10">
          ...
          <div className="flex items-center space-x-8">
            <div className="hidden md:flex items-center space-x-8">
              {["Overview", "Stack", "Projects", "Testimonials", "Certifications", "Contact"].map((item, index) => (
                <motion.a
                  key={item}
            ...
            >
              {theme === "dark" ? <Icon icon="solar:sun-bold" className="text-yellow-500" width={20} height={20} /> : <Icon icon="solar:moon-bold" className="text-blue-500" width={20} height={20} />}
            </motion.button>
          </div>
        </div>
      </div>
